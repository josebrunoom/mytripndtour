    ...
    <div class=" max-w p-8  bg-white rounded-lg shadow-md">
      <div class="flex justify-center mb-4 sm:mb-8">
        <a href="https://mytripntour.com/" target="_blank" rel="noopener noreferrer">
          <img src="../assets/Logotipo/Arquivos em Imagem/Arquivos com Fundo/Logotipo_MyTripNTour_ComFundo-1.png"
      ...
      <form @submit.prevent="">
        <div class=" flex justify-center items-center mt-3">
          <button @click="login()"
            class="google-btn input-box w-full py-2 px-4 bg-white text-gray-600 border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 ">
      ...
      <div class="mt-4">
        <input type="checkbox" class="mr-1" v-model="checkbox"> Eu concordo com a <a
          href="/roteiro/politica_privacidade">Política de Privacidade</a>
      </div>
    </div>
